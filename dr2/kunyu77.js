...
/*globalThis.getInit = function(){
    request('https://api.tyun77.cn/api.php/provide/getDomain');
    request('https://api.tyun77.cn/api.php/provide/config');
    request('https://api.tyun77.cn/api.php/provide/checkUpgrade');
    request('https://api.tyun77.cn/api.php/provide/channel');
}*/

globalThis.getInit = function(){
    var rul = 'https://api.tyun77.cn';
    request(rul + '/api.php/provide/getDomain');
    request(rul + '/api.php/provide/config');
    request(rul + '/api.php/provide/checkUpgrade');
    request(rul + '/api.php/provide/channel');
}
...
var rule = {
    ...
    url:'/api.php/provide/searchFilter?devid=7yz14f9e2jcgrqwfjj98bkd0vlflgrgv&package=com.sevenVideo.app.android&pagenum=fypage&pagesize=24&version=2.2.8&sj=$ts&type_id=fyclass',
    ...
    detailUrl:'/api.php/provide/videoDetail?devid=7yz14f9e2jcgrqwfjj98bkd0vlflgrgv&ids=fyid&package=com.sevenVideo.app.android&version=2.2.8',
...
try {
	...
	let listUrl='https://api.tyun77.cn/api.php/provide/videoPlaylist?devid=7yz14f9e2jcgrqwfjj98bkd0vlflgrgv&ids='+tid+'&package=com.sevenVideo.app.android&version=2.2.8&sj='+ts;
